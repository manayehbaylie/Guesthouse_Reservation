...
export function Booking() {
  ...
  */
  ...
  useEffect(() => {
    const loadBookingData = async () => {
      ...
      try {
        ...
        const gh = await ApiService.getGuesthouseById(
          guesthouseId
        );
  ...
  /*
  |--------------------------------------------------------------------------
  | KEEP TELEBIRR PHONE IN SYNC WITH LOGGED-IN USER
  |--------------------------------------------------------------------------
  */
  ...
  */
  ...
  const handlePayment = async (event) => {
    ...
    try {
      ...
      /*
       * Make sure we actually received a reservation.
       */
      ...
      /*
       * Save the booking result so the success page
       * can display it.
       */
       ...
       * IMPORTANT
       *
       * Notify GuestBookings.jsx that a new reservation
       * has been created.
       *
       * GuestBookings.jsx listens for this event and
       * reloads the reservation list.
       */
  ...
  */
  ...
  if (
    ...
    /*
     * Prefer the reservation's total price if
